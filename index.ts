...
import {
    initializeNominationReport, scheduleUserCsvExtract, initializeUserCsvExtract,
    ...
    try {
        ...
        client.once('ready', async () => {
            ...
            try {
                ...
                await initializeUserCsvExtract(client, process.env.REPORTING_CHANNEL_ID ?? '', serverId ?? '');
